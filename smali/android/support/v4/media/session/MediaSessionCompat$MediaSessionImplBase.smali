...
.field m:Landroid/support/v4/media/MediaMetadataCompat;

.field n:Landroid/support/v4/media/session/PlaybackStateCompat;

.field o:Landroid/app/PendingIntent;
...
.field y:Landroidx/media/VolumeProviderCompat;
...
.method public a()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->a:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public b(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    .line 1
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->j:Landroid/support/v4/media/session/MediaSessionCompat$Callback;
    ...
    .line 12
    :cond_0
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->f:Ljava/lang/Object;
    ...
    .line 15
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->h:Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MessageHandler;
    ...
    .line 34
    .line 35
    iput-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->h:Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MessageHandler;

    .line 36
    .line 37
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->j:Landroid/support/v4/media/session/MediaSessionCompat$Callback;

    .line 38
    .line 39
    invoke-virtual {v0, p0, p2}, Landroid/support/v4/media/session/MediaSessionCompat$Callback;->C(Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImpl;Landroid/os/Handler;)V
...
.method public d()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 4
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->n:Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method g(II)V
    ...
    .line 1
    iget v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->w:I
    ...
    .line 5
    .line 6
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->y:Landroidx/media/VolumeProviderCompat;
    ...
    .line 15
    .line 16
    iget v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->x:I
...
.method h(IIILjava/lang/Object;Landroid/os/Bundle;)V
    .locals 2
